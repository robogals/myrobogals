...
class Chapter(models.Model):
	...
	police_check_number_enable = models.BooleanField('Enable police check number field', default=False)
	police_check_number_required = models.BooleanField('Require student police check number field to be filled', default=False)
	police_check_number_label = models.CharField('Label for police check number field', max_length=64, blank=True)
