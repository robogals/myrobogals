...
from myrobogals.admin import widgets
from myrobogals.admin import helpers
from myrobogals.admin.util import unquote, flatten_fieldsets, get_deleted_objects, model_ngettext, model_format_dict
...
class ModelAdmin(BaseModelAdmin):
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        from myrobogals.admin.views.main import ChangeList, ERROR_FLAG
        opts = self.model._meta
        app_label = opts.app_label
