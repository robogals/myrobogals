...
class FilteredSelectMultiple(forms.SelectMultiple):
    ...
    def render(self, name, value, attrs=None, choices=()):
        ...
        output.append(u'<script type="text/javascript">addEventDjango(window, "load", function(e) {')
        # TODO: "id_" is hard-coded here. This should instead use the correct
        # API to determine the ID dynamically.
        output.append(u'SelectFilter.init("id_%s", "%s", %s, "%s"); });</script>\n' % \
            (name, self.verbose_name.replace('"', '\\"'), int(self.is_stacked), settings.MEDIA_URL))
...
class ForeignKeyRawIdWidget(forms.TextInput):
    ...
    def url_parameters(self):
        from myrobogals.admin.views.main import TO_FIELD_VAR
