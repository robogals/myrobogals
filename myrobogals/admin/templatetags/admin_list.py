...
from myrobogals.admin.views.main import ALL_VAR, EMPTY_CHANGELIST_VALUE
from myrobogals.admin.views.main import ORDER_VAR, ORDER_TYPE_VAR, PAGE_VAR, SEARCH_VAR
