...
from myrobogals.admin import ModelAdmin
from myrobogals.admin import actions
...
class AdminSite(object):
    ...
    def register(self, model_or_iterable, admin_class=None, **options):
        ...
        if admin_class and settings.DEBUG:
            from myrobogals.admin.validation import validate
        else:
    ...
    def check_dependencies(self):
        ...
        if not LogEntry._meta.installed:
            raise ImproperlyConfigured("Put 'myrobogals.admin' in your INSTALLED_APPS setting in order to use the admin application.")
    ...
    def password_change(self, request):
        ...
        """
        from myrobogals.auth.views import password_change
    ...
    def password_change_done(self, request):
        ...
        """
        from myrobogals.auth.views import password_change_done
    ...
    def logout(self, request):
        ...
        """
        from myrobogals.auth.views import logout
