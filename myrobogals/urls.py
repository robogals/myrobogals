...
urlpatterns = patterns('',
	...
	# Workshops menu
	(r'^teaching/$', 'myrobogals.rgteaching.views.schoolWorkshop.teachhome'),
	#(r'^teaching/availability/$', 'myrobogals.rgteaching.views.schoolWorkshop.availability'),
	#(r'^teaching/training/$', 'myrobogals.rgteaching.views.schoolWorkshop.training'),
	(r'^teaching/list/$', 'myrobogals.rgteaching.views.schoolWorkshop.listvisits'),
	(r'^teaching/printlist/$', 'myrobogals.rgteaching.views.schoolWorkshop.printlistvisits'),
	(r'^teaching/statshelp/$', 'myrobogals.rgteaching.views.schoolWorkshop.statshelp'),
	(r'^teaching/(?P<visit_id>\d+)/$', 'myrobogals.rgteaching.views.schoolWorkshop.viewvisit'),
	(r'^teaching/(?P<visit_id>\d+)/deletemessage/(?P<message_id>\d+)/$', 'myrobogals.rgteaching.views.schoolWorkshop.deletemessage'),
	(r'^teaching/(?P<visit_id>\d+)/invite/$', 'myrobogals.rgteaching.views.schoolWorkshop.invitetovisit'),
	(r'^teaching/(?P<visit_id>\d+)/email/$', 'myrobogals.rgteaching.views.schoolWorkshop.emailvisitattendees'),
	(r'^teaching/(?P<visit_id>\d+)/edit/$', 'myrobogals.rgteaching.views.schoolWorkshop.editvisit'),
	(r'^teaching/(?P<visit_id>\d+)/stats/$', 'myrobogals.rgteaching.views.schoolWorkshop.stats'),
	(r'^teaching/(?P<visit_id>\d+)/statsHoursPerPerson/$', 'myrobogals.rgteaching.views.schoolWorkshop.statsHoursPerPerson'),
	(r'^teaching/(?P<visit_id>\d+)/cancel/$', 'myrobogals.rgteaching.views.schoolWorkshop.cancelvisit'),
	(r'^teaching/(?P<visit_id>\d+)/reopen/$', 'myrobogals.rgteaching.views.schoolWorkshop.reopenvisit'),
	(r'^teaching/(?P<event_id>\d+)/rsvp/(?P<user_id>\d+)/(?P<rsvp_type>.+)/$', 'myrobogals.rgteaching.views.schoolWorkshop.rsvp'),
	(r'^teaching/schools/$', 'myrobogals.rgteaching.views.schoolWorkshop.listschools'),
	(r'^teaching/unstarschool/$', 'myrobogals.rgteaching.views.schoolWorkshop.unstarschool'),
	(r'^teaching/starschool/$', 'myrobogals.rgteaching.views.schoolWorkshop.starschool'),
	(r'^teaching/copyschooldir/$', 'myrobogals.rgteaching.views.schoolWorkshop.copyschool'),
	(r'^teaching/filllatlngschdir/$', 'myrobogals.rgteaching.views.schoolWorkshop.filllatlngschdir'),
	(r'^teaching/schoolsdirectory/(?P<chapterurl>.+)/$', 'myrobogals.rgteaching.views.schoolWorkshop.schoolsdirectory'),
	(r'^teaching/schools/(?P<school_id>\d+)/$', 'myrobogals.rgteaching.views.schoolWorkshop.editschool'),
	(r'^teaching/schools/(?P<school_id>\d+)/delete/$', 'myrobogals.rgteaching.views.schoolWorkshop.deleteschool'),
	(r'^teaching/schools/new/$', 'myrobogals.rgteaching.views.schoolWorkshop.newschool'),
	(r'^teaching/(?P<school_id>\d+)/newvisit/$', 'myrobogals.rgteaching.views.schoolWorkshop.newvisitwithschool'),
	(r'^teaching/new/$', 'myrobogals.rgteaching.views.schoolWorkshop.newvisit'),
	(r'^reports/$', 'myrobogals.rgteaching.views.report.report_standard'),
	(r'^globalreports/$', 'myrobogals.rgteaching.views.report.report_global'),
	(r'^globalreports/breakdown/(?P<chaptershorten>.+)/$', 'myrobogals.rgteaching.views.report.report_global_breakdown'),
	(r'^progress/$', 'myrobogals.rgchapter.views.progresschapter'),
	(r'^teaching/instantworkshop/$', 'myrobogals.rgteaching.views.instantWorkshop.instantvisit'),
