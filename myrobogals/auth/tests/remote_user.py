...
from myrobogals.auth.backends import RemoteUserBackend
from myrobogals.auth.models import AnonymousUser, User
from django.test import TestCase


class RemoteUserTest(TestCase):

    urls = 'myrobogals.auth.tests.urls'
    middleware = 'myrobogals.auth.middleware.RemoteUserMiddleware'
    backend = 'myrobogals.auth.backends.RemoteUserBackend'
...
class RemoteUserNoCreateTest(RemoteUserTest):
    ...
    backend =\
        'myrobogals.auth.tests.remote_user.RemoteUserNoCreateBackend'
...
class RemoteUserCustomTest(RemoteUserTest):
    ...
    backend =\
        'myrobogals.auth.tests.remote_user.CustomRemoteUserBackend'
