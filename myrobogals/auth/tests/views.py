...
from myrobogals.auth import SESSION_KEY
from myrobogals.auth.forms import AuthenticationForm
...
class LoginTest(AuthViewsTestCase):
    ...
    def test_current_site_in_context_after_login(self):
        response = self.client.get(reverse('myrobogals.auth.views.login'))
        self.assertEquals(response.status_code, 200)
