...
<div class="blog<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
	...
	<div class="contentdescription<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
		...
		<img src="<?php echo $this->baseurl . '/' . $cparams->get('image_path') . '/' . $this->category->image; ?>" class="image_<?php echo $this->category->image_position; ?>" alt="<?php echo $this->escape($this->params->get('page_title')); ?>"/>
		<?php endif; ?>
